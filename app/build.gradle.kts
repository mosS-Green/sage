...
android {
    namespace = "com.mossgreen.sage"
    compileSdk = 37

    defaultConfig {
        applicationId = "com.mossgreen.sage"
        minSdk = 23
        targetSdk = 36
        ...
        // strings for ~30 further locales that Sage does not translate, for ~64KB of APK
    ...
    androidResources {
        ...
        // Settings > Apps > Sage > Language. Without it a heavily localized app is
